...
public class CRC_16 {
    ...
    public static void main(String[] args) throws DecoderException {
        //ffff160021063033220217913213f29c8bf801003827
        String ss = "21 06 3033220217913213f29c8bf8 0100".toUpperCase();
        byte[] b = Hex.decodeHex(ss);
        System.out.println(b.length);
        int n = CRC_16.alex_crc16(b, b.length);
        //System.out.println(Hex.encodeHexString(intToByte(n))+"----"+Integer.toHexString(n));

        System.out.println(AnalysisUtils.checksum(b, Hex.decodeHex("3827")));
    }
}
