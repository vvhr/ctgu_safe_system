...
use app\models\DeviceParameterSetting;
use Yii;
use app\controllers\parent\ParentController;
use yii\data\ActiveDataProvider;
use linslin\yii2\curl;

class DeviceParameterSettingController extends ParentController
{
    public function actionIndex(){
        $params = Yii::$app->request->getQueryParams();
        $query = DeviceParameterSetting::find();
    ...
    public function actionView(){
        $params = Yii::$app->request->getQueryParams();
        $model = DeviceParameterSetting::find()->where(['imei'=>$params['imei']])->one();
        return $model;
    }
    ...
    public function actionSendUpdateInstruction(){
        ...
        $model = DeviceParameterSetting::findOne(['imei'=>$params['imei']]);
